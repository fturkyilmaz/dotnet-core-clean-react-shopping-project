...
const config: Config = {
  title: 'ShoppingProject Docs',
  tagline: 'Documentation for ShoppingProject API and Microservices',
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} ShoppingProject. Built with Docusaurus.`,
    },
    prism: {
