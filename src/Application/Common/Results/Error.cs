...
public sealed record Error(string Code, string Message)
{
    ...
    /// </summary>
    public static Error Unauthorized(string message = "You must be authenticated to access this resource.") =>
        new("Unauthorized", message);

    /// <summary>
    /// Creates a general business logic error.
    /// </summary>
    public static Error BusinessLogic(string message) =>
        new("BusinessLogic", message);
