...
import { loginSchema, LoginFormData } from "@/presentation/features/auth/validation/loginSchema";
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-2xl">
            ...
            <div className="absolute bottom-8 left-8 right-8 text-white">
              ...
              <p className="text-white/80">
                {t("loginDescription") || "Sign in to access your account and continue shopping."}
              </p>
            </div>
          </div>
        </motion.div>
