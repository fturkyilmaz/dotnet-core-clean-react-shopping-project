...
export const useCartNotifications = (cartConnection: signalR.HubConnection | null) => {
  useEffect(() => {
...
export const useOrderNotifications = (orderConnection: signalR.HubConnection | null) => {
  useEffect(() => {
...
export const useGeneralNotifications = (notificationConnection: signalR.HubConnection | null) => {
  useEffect(() => {
